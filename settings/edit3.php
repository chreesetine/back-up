...
<head>
    ...
    <title>Settings - Configuration of Dry only</title>
        ...
        <aside id="sidebar">
            <div class="d-flex">
             ...
             <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link has-dropdown collapsed" data-bs-toggle="collapse" data-bs-target="#records" aria-expanded="false" aria-controls="records">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="price" name="prices" required>
                            </div>
